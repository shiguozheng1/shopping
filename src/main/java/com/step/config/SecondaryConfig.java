...
@EnableJpaRepositories(
        ...
        basePackages= { "com.step.repository.secondary" })
...
public class SecondaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.step.entity.secondary");
        return entityManagerFactoryBean;
    }

    private JpaVendorAdapter jpaVendorAdapter() {
        HibernateJpaVendorAdapter jpaVendorAdapter = new HibernateJpaVendorAdapter();
        String jdbcUrl =properties.getSecondary().getUrl();
...
//        properties.put("hibernate.hbm2ddl.auto","update");
    ...
    @Primary
    public JpaTransactionManager transactionManager(@Qualifier("entityManagerFactorySecondary") EntityManagerFactory
